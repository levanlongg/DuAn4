    ...
    <div class="main-page">
        <div class="tables">
            ...
            <div class="table-responsive bs-example widget-shadow">
                ...
                @endif
                <form class="form-horizontal" action="{{url('UpdateOder/'.$editoder->ID_DDH)}}" method="post">
                    {{csrf_field()}}
                    ...
                    <table class="table table-bordered" style="margin-top:2%" !important>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width:20%"><input type="number" min="0" max="1" value="{{$editoder->TRA_TIEN}}" name="TRA_TIEN" style="width:100%" !important></td>
                                <td style="width:20%"><input type="number" min="0" max="3" value="{{$editoder->TINH_TRANG}}" name="TINH_TRANG" style="width:100%" !important></td>
                            </tr>
                        </tbody>
                    </table>
                    <br />
