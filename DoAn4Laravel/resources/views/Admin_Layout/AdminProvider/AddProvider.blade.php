            ...
            <div class="table-responsive bs-example widget-shadow">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <hr>
                        <form class="form-horizontal" action="{{route('Themncc')}}" method="post">
                            {{csrf_field()}}
                            <div class="form-group">
                                <div class="col-sm-12" !important>
                                    <b>Tên nhà cung cấp*:<b><input type="name" class="form-control" id="" placeholder="Tên nhà cung cấp" name="TEN_NHA_CUNG_CAP">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12" !important>
